...
export function InFlightInfo() {
  return (
    <div className="grid gap-10 md:grid-cols-[1.4fr_1fr]">
      ...
      <dl data-reveal="scale" style={{ ["--i" as string]: 2 }} className="self-end rounded-2xl border border-text/10 bg-surface p-6 transition-shadow hover:shadow-[0_20px_50px_-25px_rgba(0,0,0,0.5)]">
